...
from sar_alloc.observation import _insertion_position_landscape, _state_digest_from_summary
    ...
    def test_p50_uses_supplied_median_not_average(self) -> None:
        view = _insertion_position_landscape({
            "candidate_stats": {
                ...
                "candidate_position_percentiles": {"p25": 1.5, "p50": 2.0, "p75": 51.0},
                "feasible_position_percentiles": {"p25": 1.0, "p50": 1.5, "p75": 2.0},
            }
        })
